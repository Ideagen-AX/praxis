<!-- transcribed from src/ at 0.1.4 — 2026-08-14 -->
...
<script src="https://cdn.jsdelivr.net/npm/@ideagen-ax/praxis@0.1.4/dist/praxis-lucide.js"></script>
<script src="https://cdn.jsdelivr.net/npm/@ideagen-ax/praxis@0.1.4/dist/praxis-navdrawer.js"></script>
<script src="https://cdn.jsdelivr.net/npm/@ideagen-ax/praxis@0.1.4/dist/praxis-profile-menu.js"></script>
</body>
```
...
Measured from `src/praxis-tokens.css` and `src/praxis-core.css` at 0.1.4. This is the
...
Verified absent from `src/` at 0.1.4. These class names appear in Praxis selectors — so
...
Measured against `src/` at 0.1.4. Trust this file over that one on these points:
