...
>
> Praxis is at `0.1.8` and is **not production-ready**. It is published early so
...
> - **Pin the exact version** — `@0.1.8`, never `@0.1`, `^0.1.8` or `@latest`.
>
...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@ideagen-ax/praxis@0.1.8/dist/praxis.css">
```
