...
>
> Praxis is at `0.1.11` and is **not production-ready**. It is published early so
...
> - **Pin the exact version** — `@0.1.11`, never `@0.1`, `^0.1.11` or `@latest`.
>
...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@ideagen-ax/praxis@0.1.11/dist/praxis.css">
```
